...
const alumni = [
  ...
  { name: 'Hyeyoung Ryu', nameKo: '유혜영', cohort: "CTM '16", now: 'Postdoctoral Research Fellow, Vanderbilt University Medical Center — Ph.D. in Information Science, University of Washington (adv. Wanda Pratt)' },
...
const raw = [
  ...
  ["Manners Maketh MAN: Multi-Agent Norm Dynamics under Cultural Moral Values","Keeheon Lee, Kunhee Ryu, Minje Kim, Hogyun Yoo","ACM CHI 2026 Workshop on PoliSim (workshop)",2026,null,null],
...
const news = [
  ...
  {
    id: 'news-polisim-2026', slug: 'polisim-workshop-chi-2026',
    title: 'Two papers at the CHI 2026 PoliSim Workshop',
    date: '2026-02-10', author: 'HAIR Lab', authorId: 'prof-kim',
    ...
    image: 'images/default_news.svg', relatedMembers: ['prof-kim', 'ryu-kunhee', 'kim-minje', 'yoo-hogyun'], relatedProjects: ['governance-digital-twin']
  },
  {
    id: 'news-aamas-2026', slug: 'autometa-aamas-2026',
    title: 'AutoMETA accepted at AAMAS 2026',
    date: '2026-01-20', author: 'HAIR Lab', authorId: 'prof-kim',
  ...
  },
  {
    ...
    date: '2025-09-05', author: 'HAIR Lab', authorId: 'prof-kim',
    ...
    image: 'images/default_news.svg', relatedMembers: ['prof-kim'], relatedProjects: ['governance-digital-twin']
  },
  {
    id: 'news-tryout-2025', slug: 'incheon-tryout-scaleup',
    title: 'HAIR Lab leads the Global track of Incheon Startup Park TRYOUT',
    date: '2025-04-10', author: 'HAIR Lab', authorId: 'prof-kim',
    ...
    image: 'images/default_news.svg', relatedMembers: ['prof-kim'], relatedProjects: ['tryout-2026']
  },
  {
    id: 'news-chi-2025', slug: 'chi-2025-digital-legacy',
    title: 'Digital Legacy Systems paper presented at CHI 2025',
    date: '2025-04-28', author: 'HAIR Lab', authorId: 'prof-kim',
  ...
  {
    id: 'news-decision-intelligence', slug: 'decision-intelligence-grant',
    title: 'New national research project: Decision Intelligence',
    date: '2024-05-02', author: 'HAIR Lab', authorId: 'prof-kim',
  ...
  {
    id: 'news-hicss-2024', slug: 'hate-speech-llm-hicss-2024',
    title: 'LLMs for hate-speech detection presented at HICSS 2024',
    date: '2024-01-08', author: 'HAIR Lab', authorId: 'prof-kim',
...
/* ---------------- Deadlines ----------------
   Hand-maintained in data/deadlines.json (conference submission dates).
   Read as-is and embedded so the offline (file://) build stays in sync. */
const deadlines = read('deadlines');
...
const out = banner + 'window.HAIR_DATA = ' + JSON.stringify({ members, news, projects, publications, alumni, deadlines }, null, 2) + ';\n';
fs.writeFileSync(path.join(root, 'js', 'data.js'), out);

console.log('Wrote members(' + members.length + '), alumni(' + alumni.length + '), publications(' + publications.length + '), news(' + news.length + '), projects(' + projects.length + '), deadlines(' + deadlines.length + ') → data/*.json + js/data.js');
